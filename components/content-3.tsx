        ...
        <section className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16">
                ...
                <div className="relative">
                    <div className="mt-12 h-fit md:relative md:w-1/2 md:mt-0">
                        <div aria-hidden className="bg-linear-to-r z-1 from-background absolute inset-0 hidden from-55% to-transparent md:block"></div>
                    ...
                    <div className="relative z-10 space-y-4 md:absolute md:top-0 md:right-0 md:w-1/2">
